...
async function main() {
  ...
  const sandbox = createRunSandbox(sandboxProvider, {
    ...
    createosApiKey: process.env.CREATEOS_SANDBOX_API_KEY ?? process.env.CREATEOS_API_KEY,
    createosBaseUrl: process.env.CREATEOS_SANDBOX_BASE_URL ?? process.env.CREATEOS_API_URL,
    createosShape: process.env.CREATEOS_SANDBOX_SHAPE,
    createosRootfs: process.env.CREATEOS_SANDBOX_ROOTFS,
